...
pub const BLS12_381_COMPLEX_MUL_MEM_CONFIG: ArithEq384MemInputConfig = ArithEq384MemInputConfig {
    indirect_params: 2,
    rewrite_params: true,
    read_params: 2,
    write_params: 1,
...
pub fn generate_bls12_381_complex_mul_mem_inputs(
    ...
    Bls12_381Complex::calculate_mul(f1, f2, &mut f3);
    super::generate_mem_inputs(
        ...
        only_counters,
        pending,
        &BLS12_381_COMPLEX_MUL_MEM_CONFIG,
    );
}

pub fn skip_bls12_381_complex_mul_mem_inputs(
    addr_main: u64,
    data: &[u64],
    mem_collectors_info: &[MemCollectorInfo],
) -> bool {
    super::skip_mem_inputs(addr_main, data, &BLS12_381_COMPLEX_MUL_MEM_CONFIG, mem_collectors_info)
}
