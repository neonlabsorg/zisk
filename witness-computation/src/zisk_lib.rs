...
impl<F: PrimeField64> WitnessLibrary<F> for WitnessLib<F> {
    ...
    fn register_witness(&mut self, wcm: &WitnessManager<F>) {
        ...
        let mem_instances = vec![
            ...
            (ZISK_AIRGROUP_ID, ACCOUNT_DATA_AIR_IDS[0]),
